...
# NOTE: We intentionally do NOT use mcdepends here to avoid multiconfig deadlocks.
# Users must build blobs first with:
...
# The recipe will fail with a helpful message if blobs are missing.
